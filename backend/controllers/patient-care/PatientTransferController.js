      ...
      if (NewId) {
        await BaseControllerHelper.BaseCreate({
          ...
          Data: {
            ...
            UserId: LogedUser.Id,
            DoctorId: Doctor.id_data,
            Notes: '"' + FromOrganization.Name + '"-с "' + ToOrganization.Name + '"-т шилжүүллээ ',
...
async function GetCustomFormData(req, res) {
  try {
    ...
    const ConfigData = await BaseControllerHelper.GetConfigData('PatientTransfer');
