...
/// Нүүр хуудасны асуумжийн шүүлтүүр — вебийн `AdviceFeed/FilterBar.jsx`,
...
class DoctorRepository {
  ...
  /// Асуумжийн хавсралтын дээд хэмжээ — сервер чатаас бусад бүх объектод
  ...
  /// Асуумж үүсгээд нэг үйлдлээр нийтэлнэ (`CustomSaveAndPublish`).
  ///
  ...
  /// Асуумжийн хавсралт. Асуумж үүссэний ДАРАА — File мөр нь асуумжийн
  ...
  // ------------------------------------------------------------------
  // Асуумжийн урсгал — вебийн `view/AdviceHome.jsx`, `AdviceComment.jsx`
  // ------------------------------------------------------------------

  /// Хамрах хүрээг сервер тогтооно (`BuildAdviceScope`): эмч өөрийн
  /// байгууллагын түвшинд харагдах асуумжуудыг л хардаг.
  ...
  /// Нэг асуумж — урсгалын картын адил баяжуулсан, илүү том зурагтай.
  ...
  /// Асуумж хаах — вебийн дэлгэрэнгүй хуудасны "Close". Эрхийг сервер
  /// шалгана.
  ...
  Future<void> markViewed({required int adviceId, required int userId}) async {
    ...
    try {
      ...
      // Тоолуур л алдагдана; асуумжийг уншихад саад болохгүй.
    }
  }
