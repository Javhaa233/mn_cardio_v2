...
class Report14 extends Component {
  constructor(props) {
    super(props);
        ...
        <Card style={{ minHeight: "270px", marginTop: 0, marginBottom: 0 }}>
          <CardHeader color="rose" icon>
            <Typography component="h6" sx={cardIconTitleSx}>
              14. Чихрийн шижингийн сүүлийн үзлэгээр ӨҮГ{"<"}5.6 ммоль/л, буюу{" "}
              {"<"}100 мг/дл чихрийн шижинтэй идэвхтэй өвчтөнүүд
            </Typography>
          </CardHeader>
          <CardBody>
            {Loading ? (
              ...
              <div>
                <Chart Data={Data} chartType={"bar"} Id={"t13"} />
              </div>
            )}
          </CardBody>
        </Card>
