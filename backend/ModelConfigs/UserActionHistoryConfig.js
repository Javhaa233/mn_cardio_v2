...
const Model = Models.UserActionHistory;

function UserActionHistoryConfig() {
  this.Fields = [
    [
  ...
  this.ObjectName = 'UserActionHistory';
  this.Model = Model;
  this.PK = 'Id';
  this.NewObject = {};
  this.TitleObject = {
    Title: 'UserActionHistory',
    NewObjectTitle: 'UserActionHistory create',
    EditObjectTitle: 'UserActionHistory edit',
  };
}

module.exports = UserActionHistoryConfig;
