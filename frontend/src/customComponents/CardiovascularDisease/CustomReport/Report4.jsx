      ...
      <GridItem xs={12} sm={6} md={4}>
        <Box sx={indicatorCardSx}>
          <Typography variant="body2" component="div" sx={indicatorTitleSx}>
            4. Зорилтот хүн амын дунд АГ-тэй байж болзошгүй нийт хүмүүсийн дотор
            АГ-ийн улмаас эмчилгээ хийлгэж эхэлсэн хүний эзлэх хувь
          </Typography>
          <Box sx={{ flex: 1, minHeight: 0 }}>
            {Loading ? (
              ...
              <Chart Data={Data} chartType={"bar"} Id={"t3"} />
            )}
          </Box>
        </Box>
      </GridItem>
