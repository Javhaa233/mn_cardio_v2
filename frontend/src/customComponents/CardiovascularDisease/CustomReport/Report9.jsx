      ...
      <GridItem xs={12} sm={6} md={4}>
        <Box sx={indicatorCardSx}>
          <Typography variant="body2" component="div" sx={indicatorTitleSx}>
            9. ЗСӨ-ний эрсдэлээ сүүлчийн үзлэгээр зөв тодорхойлуулсан ЗСӨ-ний
            эрсдэлтэй идэвхтэй өвчтөний хувь
          </Typography>
          <Box sx={{ flex: 1, minHeight: 0 }}>
            {Loading ? (
              ...
              <Chart Data={Data} chartType={"bar"} Id={"t8"} />
            )}
          </Box>
        </Box>
      </GridItem>
