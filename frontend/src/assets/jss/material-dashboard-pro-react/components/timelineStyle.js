...
const timelineStyle = (theme) => ({
  timeline: {
    [theme.breakpoints.down("sm")]: { "&:before": { left: "5% !important" } },
    listStyle: "none",
    padding: "20px 0 20px",
    position: "relative",
    marginTop: "30px",
  ...
  badgeIcon: { width: "24px", height: "51px" },
  timelinePanel: {
  ...
  timelineHeading: { marginBottom: "15px" },
  timelineBody: { fontSize: "14px", lineHeight: "21px" },
  timelineFooter: { zIndex: "1000", position: "relative", float: "left" },
  footerTitle: {
    color: grayColor[7],
    fontWeight: "400",
    margin: "10px 0px 0px",
  },
  footerLine: { marginTop: "10px", marginBottom: "5px" },
});
