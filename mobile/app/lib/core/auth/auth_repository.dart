...
class AuthRepository {
  ...
  /// Сервер дээрх сессийг хаах — `POST /api/auth/logout` (API.md §9.9).
  ///
  /// Урьд нь энэ зам токеныг хүчингүй болгодоггүй байсан тул апп зөвхөн
  /// локал хадгалалтаа цэвэрлэдэг байв. Одоо токен үнэхээр хүчингүй болдог
  /// (сервер дээр `TOKEN_REVOCATION_ENABLED` асаалттай үед), тиймээс гарахад
  /// заавал дуудна — утас алдагдвал токен нь 10 цаг амьд үлдэхгүй.
  Future<void> logout() async {
    try {
      await _api.postObject('/api/auth/logout');
    } on ApiException {
      // Сүлжээгүй байсан ч гарах үйлдлийг зогсоохгүй — локал цэвэрлэгээ
      // хамаагүй чухал.
    }
  }
