...
class EchoTable extends BaseList {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
        ...
        <div style={{ position: "relative" }}>
          ...
          <BaseTable
            ...
            Fields={[
              ...
              { Label: t("Doctor name"), Name: "doctor_name" },
            ...
            widthPattern="100c, 110c, 120, 120, 200, 120, 120, 120"
          />
        </div>
      </div>
    );
...
export default withTranslation(undefined, { withRef: true })(EchoTable);
