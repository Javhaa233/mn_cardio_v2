...
class AtrialRhythmTable extends BaseList {
  constructor(props) {
    ...
    // refs
    this.AtrialRhythmRef = createRef();
  ...
  ShowData = (data) => {
    this.setState({
      DialogData: (
        <BaseDialog
          Title="Тосгуурын жирвэгнээ"
          ref={(ref) => (this.DialogRef = ref)}
          Close={() => this.setState({ DialogData: null })}
        >
          <AtrialRhythm
            ref={(ref) => (this.AtrialRhythmRef = ref)}
            DataId={data.Id}
          />
        </BaseDialog>
      ),
    ...
    return (
      ...
      >
        ...
        >
          ...
          <UniCard title={t("Тосгуурын жирвэгнээ")} padding={15}>
            <GridToolbar>
              <ToolbarField>
                <BaseLookUpGridLoad
                  disabled={false}
