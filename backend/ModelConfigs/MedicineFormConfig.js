...
const Model = Models.MedicineForm;

function MedicineFormConfig() {
  this.Fields = [
    [
      {
        Name: 'date_creation',
  ...
  this.TitleObject = {
    Title: 'Medicine form',
    NewObjectTitle: 'Medicine form create',
    EditObjectTitle: 'Medicine form edit',
  };
}

module.exports = MedicineFormConfig;
