...
The full inventory — 316 endpoints — is `backend/docs/API-WEB.md`, regenerated by
`node scripts/generate_api_reference.js`. Express matches paths case-insensitively, so the
