...
const Model = Models.Icd9PcLevel2;

function Icd9PcLevel2Config() {
  this.Fields = [
    [
  ...
  this.ObjectName = 'Icd9PcLevel2';
  this.Model = Model;
  this.OptionTypes = Models.OptionTypes;
  this.PK = 'id_data';
  this.NewObject = {};
  this.TitleObject = {
    Title: 'ICD9 PC Level 2',
    NewObjectTitle: 'ICD9 PC Level 2 create',
    EditObjectTitle: 'ICD9 PC Level 2 edit',
  };
}

module.exports = Icd9PcLevel2Config;
