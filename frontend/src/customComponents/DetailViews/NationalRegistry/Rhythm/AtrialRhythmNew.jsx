...
class AtrialRhythmNew extends Component {
  constructor(props) {
    super(props);
  ...
  GetData = async () => {
    ...
    if (DataId) {
      ...
      await Helper.BaseCrudHelper.BaseGetDetailInfo(
        { ObjectName: "AtrialRhythmNew", SearchOption },
        (resData) => {
          resData &&
            resData.Success &&
            resData.Data &&
  ...
  Print = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/AtrialRhythmNew/PrintReport",
          Data: { Id: DataId },
          FileName: "AtrialRhythmNew.pdf",
        },
        (Success) => {
  ...
  GetPrintNew = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/AtrialRhythmNew/PrintReportNew",
          Data: { Id: DataId },
          FileName: "AtrialRhythmNew.pdf",
        },
        (Success) => {
...
export default withTranslation(undefined, { withRef: true })(AtrialRhythmNew);
