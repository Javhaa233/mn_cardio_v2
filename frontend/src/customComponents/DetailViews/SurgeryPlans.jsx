...
class SurgeryPlans extends Component {
  constructor(props) {
    super(props);
  ...
  GetData = async () => {
    ...
    if (DataId) {
      ...
      await Helper.BaseCrudHelper.BaseGetDetailInfo(
        { ObjectName: "SurgeryPlans", SearchOption },
        (resData) => {
          resData &&
            resData.Success &&
            resData.Data &&
  ...
  Print = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/SurgeryPlans/PrintReport",
          Data: { Id: DataId },
          FileName: "SurgeryPlans.pdf",
        },
        (Success) => {
  ...
  GetPrintNew = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/SurgeryPlans/PrintReportNew",
          Data: { Id: DataId },
          FileName: "SurgeryPlans.pdf",
        },
        (Success) => {
...
export default withTranslation(undefined, { withRef: true })(SurgeryPlans);
