...
class ValveDiseases extends Component {
  constructor(props) {
    super(props);
  ...
  GetData = async () => {
    ...
    if (DataId) {
      ...
      await Helper.BaseCrudHelper.BaseGetDetailInfo(
        { ObjectName: "ValveDiseases", SearchOption },
        (resData) => {
          resData &&
            resData.Success &&
            resData.Data &&
  ...
  Print = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/ValveDiseases/PrintReport",
          Data: { Id: DataId },
          FileName: "ValveDiseases.pdf",
        },
        (Success) => {
...
export default withTranslation(undefined, { withRef: true })(ValveDiseases);
