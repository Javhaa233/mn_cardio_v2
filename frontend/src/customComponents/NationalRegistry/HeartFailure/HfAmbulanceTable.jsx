  ...
  ShowData = (data) => {
    this.setState({
      DialogData: (
        ...
        >
          <HfAmbulance
            ref={(ref) => (this.HfAmbulanceRef = ref)}
            DataId={data.Id}
          />
        </BaseDialog>
      ),
    ...
    return (
      ...
      >
        ...
        >
          ...
          <UniCard title={t("Heart Failure (Ambulance)")}>
            <GridToolbar>
              <ToolbarField>
                <BaseLookUpGridLoad
                  disabled={false}
            ...
            >
              <BaseGrid
                ...
                Fields={[
                  ...
                  {
                    Label: t("Эрүүл мэндийн байгууллага"),
                ...
                FillHeight={true}
                widthPattern="150, 180, 120l, 130, 130, 100c, 110c, 110c"
