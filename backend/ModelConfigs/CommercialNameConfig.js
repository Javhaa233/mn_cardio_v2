...
const Model = Models.CommercialName;

function CommercialNameConfig() {
  this.Fields = [
    [
      {
        Name: 'date_creation',
  ...
  this.ObjectName = 'CommercialName';
  this.Model = Model;
  ...
  this.TitleObject = {
    ...
    NewObjectTitle: 'Commercial name create',
    EditObjectTitle: 'Commercial name edit',
  };
}

module.exports = CommercialNameConfig;
