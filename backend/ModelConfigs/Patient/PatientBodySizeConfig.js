...
const Model = Models.PatientBodySize;

function PatientBodySizeConfig() {
  this.Fields = [
    [
  ...
  this.ObjectName = 'PatientBodySize';
  this.Model = Model;
  this.OptionTypes = Models.OptionTypes;
  this.PK = 'Id';
  this.NewObject = {};
  this.TitleObject = {
    Title: 'Patient body size',
    NewObjectTitle: 'Patient body size create',
    EditObjectTitle: 'Patient body size edit',
  };
}

module.exports = PatientBodySizeConfig;
