...
const Model = Models.OperationRoom;

function OperationRoomConfig() {
  this.Fields = [
    [
      {
        Name: 'date_creation',
  ...
  this.TitleObject = {
    ...
    NewObjectTitle: 'Operation room create',
    EditObjectTitle: 'Operation room edit',
  };
}

module.exports = OperationRoomConfig;
