        ...
        <Card style={{ minHeight: "270px", marginTop: 0, marginBottom: 0 }}>
          <CardHeader color="rose" icon>
            <Typography component="h6" sx={cardIconTitleSx}>
              7. Зүрхний шигдээс, тархины харвалтын хоёрдогч урьдчилан сэргийлэх
              эмчилгээ хийлгэж байгаа ЗСӨ-ний түүхтэй идэвхтэй өвчтөнүүдийн хувь
            </Typography>
          </CardHeader>
          <CardBody>
            {Loading ? (
              ...
              <Chart Data={Data} chartType={"bar"} Id={"t6"} />
            )}
          </CardBody>
        </Card>
      </GridItem>
