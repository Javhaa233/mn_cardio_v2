...
class Report10 extends Component {
  constructor(props) {
    super(props);
      ...
      <GridItem xs={12} sm={6} md={4}>
        <Box sx={indicatorCardSx}>
          <Typography variant="body2" component="div" sx={indicatorTitleSx}>
            10. ЗСӨ-ний сүүлчийн үзлэгээр цусны даралтыг нь хэмжиж тэмдэглэсэн
            ЗСӨ-ний эрсдэлтэй идэвхтэй өвчтөний хувь
          </Typography>
          <Box sx={{ flex: 1, minHeight: 0 }}>
            {Loading ? (
              ...
              <Chart Data={Data} chartType={"bar"} Id={"t9"} />
            )}
          </Box>
        </Box>
      </GridItem>
