...
class SudasForm extends BaseCustomForm {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
  ...
  GetLastData = async () => {
    ...
    if (PatientRegNo) {
      await Helper.BaseCrudHelper.CallService(
        ...
        { PatientRegNo, Category: "sudsan_dotuurh" },
        (resData) => {
          let DataId = null;
        ...
        <GridItem xs={12} md={12}>
          {Fields && Fields.length > 0 && (
            <div>
              ...
              {/* 5. ЦЭЭЖНИЙ РЕНТГЕН ХАРАЛТ */}
              <GroupPanel title={t("5. ЦЭЭЖНИЙ РЕНТГЕН ХАРАЛТ")} level={1}>
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("tseej_rentgen")}
                />
              </GroupPanel>

              {/* 6. ЗҮРХНИЙ ХЭТ АВИАН ОНОШИЛГОО */}
              <GroupPanel title={t("6. ЗҮРХНИЙ ХЭТ АВИАН ОНОШИЛГОО")} level={1}>
                <BaseInputMask
                  ChangeValue={this.ChangeValue}
              ...
              {/* 7. УЛААН ХООЛОЙН ЗҮРХНИЙ ХЭТ АВИАН ШИНЖИЛГЭЭ */}
              <GroupPanel
                title={t("7. УЛААН ХООЛОЙН ЗҮРХНИЙ ХЭТ АВИАН ШИНЖИЛГЭЭ")}
                level={1}
              >
                <BaseInputMask
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_date")}
                  Mask={"9999-99-99"}
                  MaskChar={"_"}
                  defaultValue={Helper.ObjectHelper.getDateYMD()}
                />
                {/* ТЕЕ (ТХТЦ-н хэмжээ) */}
                <GroupPanel title={t("ТЕЕ (ТХТЦ-н хэмжээ)")} level={2}>
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_tte")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_tee")}
                  />
                </GroupPanel>
                {/* Ирмэгүүд */}
                <GroupPanel title={t("Ирмэгүүд")} level={2}>
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_anteroinferor")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_posterosuperior")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_aortic")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_posterior")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_inferior")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("u_h_superior")}
                  />
                </GroupPanel>
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_la_size")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_mv")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_ven_orolt")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_uad")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_bx_size")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_bt_size")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_tapse")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_arter")}
                />
                <BaseRadio
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_shunt")}
                />

                {/* <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_bt_dd")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_zt_dd")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_ua_dd")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_balloon_size")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_asd")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_fluoroscopy_hour")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_h_emboli")}
                /> */}
              </GroupPanel>

              {/* 8. КАТЕТР АНГИОГРАФИ ХИЙСЭН ТУХАЙ */}
              <GroupPanel
                title={t("8. КАТЕТР АНГИОГРАФИ ХИЙСЭН ТУХАЙ")}
                level={1}
              >
                <BaseInputMask
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("katetr_date")}
                  Mask={"9999-99-99"}
                  MaskChar={"_"}
                  defaultValue={Helper.ObjectHelper.getDateYMD()}
                />
                ...
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("pvr")}
                />

                {/* Мэс заслын хугацаа */}
                <GroupPanel title={t("Мэс заслын хугацаа")} level={2}>
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("ms_full_time")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("ms_perfuz_time")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("ms_aort_time")}
                  />
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("ms_anes_time")}
                  />

                  {/* is_now_hundrel */}
                  <BaseRadio
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("is_now_hundrel")}
                  />
                  <div
                    id="is_now_hundrelChild"
                    className={classes.childDiv}
                    style={{ display: this.GetDisplay("is_now_hundrel") }}
                  >
                    <BaseTextField
                      ChangeValue={this.ChangeValue}
                      Config={this.GetConfigField("now_hundrel")}
                      FullWidth={true}
                    />
                  </div>
                  ...
                  <BaseRadio
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("is_next_ert_hundrel")}
                  />
                  <div
                    id="is_next_ert_hundrelChild"
                    className={classes.childDiv}
                    style={{ display: this.GetDisplay("is_next_ert_hundrel") }}
                  >
                    <BaseTextField
                      ChangeValue={this.ChangeValue}
                      Config={this.GetConfigField("next_ert_hundrel")}
                      FullWidth={true}
                    />
                  </div>
                  {/* is_next_hojuu_hundrel */}
                  <BaseRadio
                    ChangeValue={this.ChangeValue}
                    Config={this.GetConfigField("is_next_hojuu_hundrel")}
                  />
                  <div
                    id="is_next_hojuu_hundrelChild"
                    className={classes.childDiv}
                    style={{
                      display: this.GetDisplay("is_next_hojuu_hundrel"),
                    }}
                  >
                    <BaseTextField
                      ChangeValue={this.ChangeValue}
                      Config={this.GetConfigField("next_hojuu_hundrel")}
                      FullWidth={true}
                    />
                  </div>
                </GroupPanel>
                ...
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("ekstubatsi_hugatsaa")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("erchimt_hugatsaa")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("tasagt_hevtsen_hugatsaa")}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("niit_hevtsen_hugatsaa")}
                />
                ...
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("going_time")}
                  FullWidth={true}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("u_tasagt_hevtsen_hugatsaa")}
                  FullWidth={true}
                />
              </GroupPanel>

              {/* 9.СУДСАН ДОТУУРХ МЭС ЗАСАЛ ХИЙГДСЭН ОНОШ */}
              <GroupPanel
                title={t("9. СУДСАН ДОТУУРХ МЭС ЗАСАЛ ХИЙГДСЭН ОНОШ")}
                level={1}
              >
...
Хэмжээ ______мм
Хэлбэр _________
Шунтын чиглэл               □ З-Б             □ Б-З          □ Шунт тэнцсэн
...
Бусад /___________________________/ */}
                ...
                <div id="neelttei_mes_onoshChilds">
                  <div
                    id="neelttei_mes_onoshChild-1"
                    className={classes.childDiv}
                    style={{
                      display: this.GetValueDisplay("neelttei_mes_onosh", 1),
                    }}
                  >
                    <div className={classes.childDiv}>
                      <p>Зүрхний хэт авиан шинжилгээгээр:</p>
                      <BaseTextField
                        ChangeValue={this.ChangeValue}
                        Config={this.GetConfigField("ha_txt_tso_helber")}
                        FullWidth={true}
                      />
                      <BaseTextField
                        ChangeValue={this.ChangeValue}
                        Config={this.GetConfigField("ha_txt_tso_hemjee")}
                      />
                      <BaseRadio
                        ChangeValue={this.ChangeValue}
                        Config={this.GetConfigField("ha_txt_shunt_chiglel")}
                      />
                    </div>

                    <div className={classes.childDiv}>
                      <p>Улаан хоолойн зүрхний хэт авиан шинжилгээгээр:</p>
                      <BaseTextField
                        ChangeValue={this.ChangeValue}
                        Config={this.GetConfigField("uh_txt_tso_helber")}
                        FullWidth={true}
                      />
                      <BaseTextField
                        ChangeValue={this.ChangeValue}
                        Config={this.GetConfigField("uh_txt_tso_hemjee")}
                      />
                      <BaseRadio
                        ChangeValue={this.ChangeValue}
                        Config={this.GetConfigField("uh_txt_shunt_chiglel")}
                      />
                    </div>
                  </div>
                </div>
                ...
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("mes_umnuh_onosh")}
                  FullWidth={true}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("tuluv_mes")}
                  FullWidth={true}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("hiigdsen_mes")}
                  FullWidth={true}
                />
                <BaseTextField
                  ChangeValue={this.ChangeValue}
                  Config={this.GetConfigField("nemelt_ajilbar")}
                  FullWidth={true}
                />
              </GroupPanel>

              {/* 10. МЭС ЗАСЛЫН ДАРААХ ХЯНАЛТ */}
              <GroupPanel title={t("10. МЭС ЗАСЛЫН ДАРААХ ХЯНАЛТ")} level={1}>
                <table className={classes.customTable}>
                  <thead>
                    <tr>
                      <th>Үзүүлэлт</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bh_hemjee_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bh_hemjee_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bh_hemjee_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bh_hemjee_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bh_hemjee_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bt_hemjee_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bt_hemjee_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bt_hemjee_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bt_hemjee_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("bt_hemjee_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("lvdd_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("lvdd_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("lvdd_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("lvdd_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("lvdd_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("ef_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("ef_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("ef_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("ef_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("ef_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      <th>Уушгины артерийн даралт (mmHg)</th>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField(
                            "uushig_arteri_daralt_1d",
                          )}
                        />
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("uldegdel_shunt_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("uldegdel_shunt_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("uldegdel_shunt_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("uldegdel_shunt_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("uldegdel_shunt_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      <th>Шүхэрийн байрлал</th>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("shuher_bairlal_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("shuher_bairlal_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("shuher_bairlal_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("shuher_bairlal_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("shuher_bairlal_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      <th>Үнхэлцгийн шингэн</th>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("unheltseg_shingen_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("unheltseg_shingen_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("unheltseg_shingen_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("unheltseg_shingen_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("unheltseg_shingen_6m")}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("hem_aldagdal_1d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("hem_aldagdal_7d")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("hem_aldagdal_1m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("hem_aldagdal_3m")}
                        />
                      </td>
                      <td>
                        <CustomTextField
                          ChangeValue={this.ChangeValue}
                          Config={this.GetConfigField("hem_aldagdal_6m")}
                        />
                      </td>
                    </tr>
                  </tbody>
              ...
              {/* 11. ЭМЧИЛГЭЭ */}
              <GroupPanel title={t("11. ЭМЧИЛГЭЭ")} level={1}>
                <div className={classes.childDiv}>
                  <p>Антиагрегант:</p>
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
...
export default withTranslation(undefined, { withRef: true })(
  withMui5Styles(customFormStyles)(SudasForm),
);
