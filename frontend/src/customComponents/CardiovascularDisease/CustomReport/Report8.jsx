      ...
      <GridItem xs={12} sm={6} md={4}>
        <Box sx={indicatorCardSx}>
          <Typography variant="body2" component="div" sx={indicatorTitleSx}>
            8. Статинаар эмчлэгдэж байгаа ЗСӨ-ний ≥ 30% эрсдэл бүхий идэвхтэй
            өвчтөнүүдийн хувь (ЗСӨ-ий түүхтэй өвчтөнүүдийг оролцуулахгүй)
          </Typography>
          <Box sx={{ flex: 1, minHeight: 0 }}>
            {Loading ? (
              ...
              <Chart Data={Data} chartType={"bar"} Id={"t7"} />
            )}
          </Box>
        </Box>
      </GridItem>
