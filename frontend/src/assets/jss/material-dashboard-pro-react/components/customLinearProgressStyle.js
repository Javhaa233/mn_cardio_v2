...
const customLinearProgressStyle = {
  ...
  infoBackground: { background: "rgba(" + hexToRgb(infoColor[0]) + ", 0.2)" },
  roseBackground: { background: "rgba(" + hexToRgb(roseColor[0]) + ", 0.2)" },
  grayBackground: { background: "rgba(" + hexToRgb(grayColor[5]) + ", 0.2)" },
};
