...
class BloodStrokeTable extends BaseList {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
    ...
    // refs
    this.BloodStrokeTable = createRef();
  }
...
export default withTranslation(undefined, { withRef: true })(BloodStrokeTable);
