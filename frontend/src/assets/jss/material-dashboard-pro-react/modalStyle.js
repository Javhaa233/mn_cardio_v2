...
const modalStyle = (theme) => ({
  modalRoot: { overflow: "auto", alignItems: "unset", justifyContent: "unset" },
  modal: {
    [theme.breakpoints.up("sm")]: { maxWidth: "500px", margin: "auto" },
    borderRadius: "6px",
  ...
  modalSmallFooterSecondButton: { marginBottom: "0", marginLeft: "5px" },
});
