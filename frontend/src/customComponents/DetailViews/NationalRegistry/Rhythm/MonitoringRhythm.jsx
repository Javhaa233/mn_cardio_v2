...
class MonitoringRhythm extends Component {
  constructor(props) {
    super(props);
  ...
  GetData = async () => {
    ...
    if (DataId) {
      ...
      await Helper.BaseCrudHelper.BaseGetDetailInfo(
        { ObjectName: "MonitoringRhythm", SearchOption },
        (resData) => {
          resData &&
            resData.Success &&
            resData.Data &&
  ...
  Print = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/MonitoringRhythm/PrintReport",
          Data: { Id: DataId },
          FileName: "MonitoringRhythm.pdf",
        },
        (Success) => {
  ...
  GetPrintNew = async (callback) => {
    ...
    if (DataId) {
      await Helper.BaseCrudHelper.BasePrintReport(
        {
          Url: "/MonitoringRhythm/PrintReportNew",
          Data: { Id: DataId },
          FileName: "MonitoringRhythm.pdf",
        },
        (Success) => {
...
export default withTranslation(undefined, { withRef: true })(MonitoringRhythm);
