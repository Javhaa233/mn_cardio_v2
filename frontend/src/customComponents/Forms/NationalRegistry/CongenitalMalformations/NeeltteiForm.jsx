...
class NeeltteiForm extends BaseCustomForm {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
  ...
  GetLastData = async () => {
    ...
    if (PatientRegNo) {
      await Helper.BaseCrudHelper.CallService(
        ...
        { PatientRegNo, Category: "neelttei" },
        (resData) => {
          let DataId = null;
        ...
        <GridItem xs={12} md={12}>
          {Fields && Fields.length > 0 && (
            <div>
              ...
              {/* 6. УЛААН ХООЛОЙН ЗҮРХНИЙ ХЭТ АВИАН ШИНЖИЛГЭЭ */}
              <GroupPanel
                title={t("6. УЛААН ХООЛОЙН ЗҮРХНИЙ ХЭТ АВИАН ШИНЖИЛГЭЭ")}
                level={1}
              >
                <BaseInputMask
                  ChangeValue={this.ChangeValue}
              ...
              {/* 7. КАТЕТР АНГИОГРАФИ ХИЙСЭН ТУХАЙ */}
              <GroupPanel
                title={t("7. КАТЕТР АНГИОГРАФИ ХИЙСЭН ТУХАЙ")}
                level={1}
              >
                <BaseInputMask
                  ChangeValue={this.ChangeValue}
                ...
                <div
                  ...
                  className={classes.childDiv}
                  style={{ display: this.GetDisplay("is_next_hojuu_hundrel") }}
                >
                  <BaseTextField
                    ChangeValue={this.ChangeValue}
              ...
              {/* 8. НЭЭЛТТЭЙ МЭС ЗАСАЛ ЭМЧИЛГЭЭ ОНОШ */}
              <GroupPanel
                title={t("8. НЭЭЛТТЭЙ МЭС ЗАСАЛ ЭМЧИЛГЭЭ ОНОШ")}
                level={1}
              >
                {/* <p>Тосгуур хоорондын таславчийн цоорхой</p>
                <p>Ховдол хоорондын таславчийн цоорхой</p>
                <p>Артерийн битрүүрээгүй цорго</p>
                <p>Уушгины артерийн нарийсал</p>
                <p>Бусад /___________________________/</p> */}
              ...
              {/* 9. МЭС ЗАСЛЫН ДАРААХ ХЯНАЛТ */}
              <GroupPanel title={t("9. МЭС ЗАСЛЫН ДАРААХ ХЯНАЛТ")} level={1}>
                <table className={classes.customTable}>
                  <thead>
                    <tr>
                      <th>Үзүүлэлт</th>
              ...
              {/* 10. ЭМЧИЛГЭЭ */}
              <GroupPanel title={t("10. ЭМЧИЛГЭЭ")} level={1}>
...
export default withTranslation(undefined, { withRef: true })(
  withMui5Styles(customFormStyles)(NeeltteiForm),
);
