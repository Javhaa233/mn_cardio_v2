...
const Model = Models.TicketSoum;

function TicketSoumConfig() {
  this.Fields = [
    [
      {
        Name: 'date_creation',
  ...
  this.TitleObject = {
    Title: 'Ticket soum',
    NewObjectTitle: 'Ticket soum create',
    EditObjectTitle: 'Ticket soum edit',
  };
}

module.exports = TicketSoumConfig;
