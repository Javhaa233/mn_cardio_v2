...
const events = [
  ...
  {
    title: i18n.t("Click for Creative Tim"),
    start: new Date(y, m, 21),
    end: new Date(y, m, 22),
    color: "orange",
  },
  {
    title: i18n.t("Click for Google"),
    start: new Date(y, m, 21),
    end: new Date(y, m, 22),
    color: "rose",
  },
