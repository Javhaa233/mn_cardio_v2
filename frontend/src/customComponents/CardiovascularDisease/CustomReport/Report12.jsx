...
class Report12 extends Component {
  constructor(props) {
    super(props);
      ...
      <GridItem xs={12} sm={6} md={4}>
        <Box sx={indicatorCardSx}>
          <Typography variant="body2" component="div" sx={indicatorTitleSx}>
            12. ЗСӨ-ний сүүлчийн үзлэгээр
            {" <30% эрсдэлтэй, артерийн даралт нь <140/90,"} идэвхтэй өвчтөний
            тоо
          </Typography>
          <Box sx={{ flex: 1, minHeight: 0 }}>
            {Loading ? (
              ...
              <div>
                <Chart Data={Data} chartType={"bar"} Id={"t11"} />
              </div>
            )}
          </Box>
        </Box>
