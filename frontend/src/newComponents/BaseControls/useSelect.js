...
export default ({
  ...
  const loadDataSource = () => {
    if (Array.isArray(props.dataSource)) setDataSource(props.dataSource);
    if (props.dataSource && typeof props.dataSource === "function") {
      const ds = props.dataSource(rootFilter);
      setDataSource(ds);
    }
  };
  ...
  useEffect(() => {
    if (selector && selector.dataSource && Array.isArray(storeDataSource))
