...
const customCheckboxRadioSwitch = {
  checkRoot: { padding: "14px", "&:hover": { backgroundColor: "unset" } },
  ...
  iconCheckbox: {
    ...
    "&:hover": {
      color: roseColor[0],
      "& > span:first-child": { borderColor: roseColor[0] },
    },
  },
  iconCheckboxChecked: {
    color: roseColor[0],
  ...
  switchBase: { color: primaryColor[0] + "!important" },
  switchIcon: {
  ...
  switchChecked: {
    ...
    "& $switchIcon": { borderColor: primaryColor[0] },
  },
};
