...
import PatientMonitoring from "customComponents/DetailViews/PatientMonitoring";
...
class PatientMonitoringTable extends BaseList {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
    ...
    // refs
    this.PatientMonitoring = createRef();
  ...
  ShowData = (data) => {
    ...
    this.setState({
      DialogData: (
        ...
        >
          <PatientMonitoring
            ref={(ref) => (this.PatientMonitoring = ref)}
            DataId={data.id_data}
            PatientId={PatientId}
            ObjectName="PatientMonitoring"
          />
        ...
        {FirstDataCheck ? null : (
          <div style={{ position: "relative" }}>
            ...
            <BaseGrid
              ...
              Fields={[
                {
                  Label: t("PatientMonitoring date"),
                  Name: "visit_date",
                  Type: "Date",
                },
...
export default PatientMonitoringTable;
