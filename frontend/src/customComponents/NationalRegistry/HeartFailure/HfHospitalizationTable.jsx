...
class HfHospitalizationTable extends BaseList {
  constructor(props) {
    ...
    // refs
    this.HfHospitalizationRef = createRef();
  ...
  ExportExcel = async () => {
    const ObjectName = "HfHospitalization";
    if (!ObjectName) {
      const { t } = this.props;
          ...
          <UniCard title={t("Heart Failure (Hospitalization)")}>
            ...
            >
              <BaseGrid
                ...
                FillHeight={true}
                widthPattern="150, 120l, 100c, 110c"
