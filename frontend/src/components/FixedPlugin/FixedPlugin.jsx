    ...
    <div className={"fixed-plugin"}>
      <div id="fixedPluginClasses" className={props.fixedClasses}>
        ...
        <ul className="dropdown-menu">
          <li className="header-title">{t('SIDEBAR FILTERS')}</li>
          ...
          <li className="header-title">{t('SIDEBAR BACKGROUND')}</li>
          <li className="adjustments-line">
            <a className="switch-trigger active-color">
              <div className="badge-colors text-center">
                <span
          ...
          <li className="adjustments-line">
            <a className="switch-trigger">
              <p className="switch-label">{t('Sidebar Mini')}</p>
              <Switch
          ...
          <li className="adjustments-line">
            <a className="switch-trigger">
              <p className="switch-label">{t('Sidebar Image')}</p>
              <Switch
                checked={showImage}
          ...
          <li className="header-title">{t('Images')}</li>
